						...
						<div class="box-cnt js-rep-detail-container">
							<div class="form">
								<fieldset>
									...
									<input type="hidden" id="videoId" name ="id" value="${videoId}" />
									<div class="control-group">
										<label class="control-label">名称</label>
										<div class="control error">
											<input type="text" name="name" max="16" maxlength="16" error="视频名长度少于16个字" 
											require="require" require_msg ="视频名不能为空"  placeholder="输入视频名称"  />

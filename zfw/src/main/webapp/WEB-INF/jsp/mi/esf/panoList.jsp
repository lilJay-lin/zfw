<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="box-cnt js-shh-panos-container" style="display:none">
	<div class="datatable" id="panoList">
		...
		<div class="datatable-toolbar js-not-detail">
			<div class="toolbar">
				...
				<a class="btn btn-primary" href="${ctx}/mi/${shhId }/esfpano/add">新增</a>
			</div>
		</div>
		...
		var panoDeling = false;
	  	...
	  	function delPano(e,panoIds){
	  		...
	  		panoDeling = true;
	  		var url = "${ctx}/mi/esfpano/batchDel";
	  		$.ajax({
	  			type:"post",
	  			data:{"panoIds":panoIds},
	  			url:url,
	  			async:true,
	  			dataType:"json",

		...
		<script type="text/x-handlebars" id="photo-template">
			...
			<tr>
				...
				<td>
					...
					<a class="btn btn-info" href="${ctx}/mi/${rcId}/xqphoto/{{id}}/edit">
						<i class="icon-edit "></i>                                            
					</a>
		...
		<script type="text/x-handlebars" id="shh-template">
			...
			<tr>
				...
				<td>
					...
					<a class="btn btn-info" href="${ctx}/mi/${rcId}/esf/{{id}}/edit">
						<i class="icon-edit "></i>                                            
					</a>
					<a class="btn btn-danger" href="javascript:;" onclick="delShh(this,'{{id}}');return false;" data-id="{{id}}">
						<i class="icon-trash "></i> 
					</a>
				</td>
			</tr>
		...
		<script type="text/x-handlebars" id="rh-template">
			...
			<tr>
				...
				<td>
					...
					<a class="btn btn-info" href="${ctx}/mi/${rcId}/zf/{{id}}/edit">
						<i class="icon-edit "></i>                                            
					</a>
					<a class="btn btn-danger" href="javascript:;" onclick="delRh(this,'{{id}}');return false;" data-id="{{id}}">
						<i class="icon-trash "></i> 
					</a>
				</td>
			</tr>

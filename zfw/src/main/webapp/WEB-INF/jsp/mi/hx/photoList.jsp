<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="box-cnt js-ht-photos-container" style="display:none">
	<div class="datatable" id="photoList">
		...
		<div class="datatable-toolbar js-not-detail">
			<div class="toolbar">
				...
				<a class="btn btn-primary" href="${ctx}/mi/${htId }/hxphoto/add">新增</a>
			</div>
		</div>
		...
		var photoDeling = false;
	  	...
	  	function delPhoto(e,imageIds){
	  		...
	  		photoDeling = true;
	  		var url = "${ctx}/mi/hxphoto/batchDel";
	  		$.ajax({
	  			type:"post",

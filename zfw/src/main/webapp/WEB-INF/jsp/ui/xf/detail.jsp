	...
	<div class="main">
		...
		<section class=" pd10 f14 mt10 bdt bdb lh105">
			<div>
				...
				<p>
					开盘时间：<span class="f999">预计2015年6月14日1-3、5#开盘</span>
				</p>
				<p>
					入住时间：<span class="f999">预计2015年下半年一期9栋楼交房</span>
				</p>
				<div class="l"></div>
				<p>
					物业类型：<span class="f999">住宅</span>
				</p>
				<p>
					建筑类别：<span class="f999">板楼,多层,小高层</span>
				</p>
				<p>
					装修状况：<span class="f999">毛坯</span>
				</p>
				<p>
					住<span style="margin-right: .5em;"></span>户<span
						style="margin-right: .5em;"></span>数：<span class="f999">186户</span>
				</p>
				<p>
					容<span style="margin-right: .5em;"></span>积<span
						style="margin-right: .5em;"></span>率：<span class="f999">1.50</span>
				</p>
				<p>
					绿<span style="margin-right: .5em;"></span>化<span
						style="margin-right: .5em;"></span>率：<span class="f999">30%</span>
				</p>
				<p>
					停<span style="margin-right: .5em;"></span>车<span
						style="margin-right: .5em;"></span>位：<span class="f999">共1598个</span>
				</p>
				<p>
					产权年限：<span class="f999">70年</span>
				</p>
				<div class="l"></div>
				<p>
					开<span style="margin-right: .5em;"></span>发<span
						style="margin-right: .5em;"></span>商： <span class="f999">北京首都开发股份有限公司</span>
				</p>
				<p>
					预售许可证：<span class="f999">京房售证字(2014)188号</span>
				</p>
				<p>
					物业公司： <span class="f999">北京首开鸿城实业有限公司</span>
				</p>
				<p>
					物<span style="margin-right: .5em;"></span>业<span
						style="margin-right: .5em;"></span>费： <span class="f999">2.98元/平方米·月</span>
				</p>
				<div class="l"></div>
				<h3>楼盘介绍</h3>
				...
				<div class="l"></div>
				<h3>交通配套</h3>
				<p class="f999">公交：425路、927路、38路、268路、831路、834路、56路、126路、66路、76A路、864路、223路
					地铁：2号线黄边站</p>
			</div>
		</section>
		<section class="mt10 homeList bdb">
			<ul>
				...
				<li><a href="/xf/bj/1010710185.htm">
						<div class="img">
							<img
								src="http://img2.imgtn.bdimg.com/it/u=4157877028,1827198230&fm=21&gp=0.jpg">
						</div>
						<div class="txt">
							<p class="x-intro"></p>
							<h2>户型1</h2>
							<span class="new">在售</span>
							<p></p>
							<p>3室2厅2卫1厨 约159㎡</p>
						</div>
				</a></li>
		...
		<section class=" pd10 mt10 bdt bdb f14">
			...
			<p class="pdY5">
				<a id="wapxfxqy_B02_27"
					...
					class="f000">地址：<span class="f999"> 新塘镇花园东路6号新塘镇花园东路6号新
				</span></a>
			</p>

			<!-- 路线导航需要修改 -->
			<div style="position: relative; display: none;" id="drivedaohang">
				<a class="rbox6 f16 awhite"
					href="/xf.d?m=drivemap&amp;mapx=113.57745361328125000000&amp;mapy=23.10794067382812500000&amp;src=xf"
					style="position: absolute; width: 80px; height: 30px; right: 4px; top: 98px; background: rgba(0, 0, 0, 0.5) url(http://js.soufunimg.com/wireless_m/touch/img/ico-xfxq-map.png) no-repeat 4px center; background-size: 16px 16px; padding-left: 16px; line-height: 30px; z-index: 10">路线导航</a>
			</div>
			<!-- 路线导航需要修改 -->
			...
			<div id="wapxfxqy_B02_27" style="position: relative;">
				<a
					href="/map/?c=map&amp;a=xfMapbyId&amp;city=gz&amp;xqid=2811346746">
					<img
					src="http://api.map.baidu.com/staticimage?width=300&height=130&zoom=14&markers=112.489633,23.054454&markerStyles=s,"
					width="100%" alt=""> <span class="maptxt">广州新塘新世界花园</span>
				</a>
			</div>
		</section>
		...
		<section class="NewsList mt10" >
			...
			<ul id="itemList">
				<li ><a
					href="http://www.fang.com/news/2015-06-09/16194688.htm"
					id="wapdsy_D04_23">
						...
						<div class="bord">
							...
							<div class="lt">
								<img
									data-original="http://imgs.soufun.com/viewimage/news/2015_06/09/news/1433810092437_000/120x120.jpg"
									alt=""
									src="http://www.pdfangchan.com/upload/house/2011-12-19/2011121915571257_120x90.jpg">
							</div>

							<div class="rt">
								<h3>京拟用闲置地建养老设施</h3>
								<p>北京拟利用国有企业闲置土地，建32个养老设施。</p>
							</div>
						</div>
				</a></li>
				...
				<li ><a
					href="http://www.fang.com/news/2015-06-09/16194951.htm"
					id="wapdsy_D04_27">
						...
						<div class="bord">
							...
							<div class="lt">
								<img
									data-original="http://imgs.soufun.com/viewimage/news/2015_06/09/news/1433810779273_000/120x120.jpg"
									alt=""
									src="http://www.pdfangchan.com/upload/house/2011-12-19/2011121915571257_120x90.jpg">
							</div>
							...
							<div class="rt">
								<h3>万科将轻资产做到底</h3>
								<p>近日，万科将分拆物流地产，将轻资产做到底。</p>
							</div>
						</div>
				</a></li>

				<li ><a
					href="http://m.fang.com/zt/wap/201504/xfwtdyjwx.html?city=bj&amp;m=xfdg"
					id="wapdsy_D04_28">
						...
						<div class="bord">
							...
							<div class="lt">
								<img
									data-original="http://imgn3.soufunimg.com/viewimage/news/2015_06/08/1433746764656/120x120.jpg"
									alt=""
									src="http://www.pdfangchan.com/upload/house/2011-12-19/2011121915571257_120x90.jpg">
							</div>

							<div class="rt">
								<h3>新房委托第一季：无补贴不买房</h3>
								<p>互联网购房新模式，新房委托第一季：无补贴不买房。</p>
							</div>
						</div>
				</a></li>

				<li ><a
					href="http://m.fang.com/zt/wap/201505/sbb_swiper_ani_css.html?city=bj&amp;m=xfdg"
					id="wapdsy_D04_29">
						...
						<div class="bord">
							...
							<div class="lt">
								<img
									data-original="http://imgn5.soufunimg.com/viewimage/news/2015_06/03/1433310943441/120x120.jpg"
									alt=""
									src="http://www.pdfangchan.com/upload/house/2011-12-19/2011121915571257_120x90.jpg">
							</div>
							...
							<div class="rt">
								<h3>房大十八变—不变大妈变女神</h3>
								<p>是Diao丝？是女神？海量盘等你评，最帅评房师就是你！</p>
							</div>
						</div>
				</a></li>

				<li ><a
					href="http://www.fang.com/news/2015-05-14/15918529.htm"
					id="wapdsy_D04_30">
						...
						<div class="bord">
							...
							<div class="lt">
								<img
									data-original="http://img.soufun.com/viewimage/news/2015_05/14/news/1431592806016_000/120x120.jpg"
									alt=""
									src="http://www.pdfangchan.com/upload/house/2011-12-19/2011121915571257_120x90.jpg">
							</div>

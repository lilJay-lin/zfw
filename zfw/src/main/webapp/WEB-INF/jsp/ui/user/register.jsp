	...
	<div class="main">
		...
		<div class="mLogin">
			<div class="wapForm phone mt10">
				...
				<form action="" method="post">
					...
					<input type="text" maxlength="20" id="txtPwd" name="txtPwd"
						value="请输入密码" class="ipt-text mt10" onpaste="return true;"
			...
			<a href="javascript:void(0);"
				class="formbtn02 mt10 jsUserSubmit disabled" onclick="submitForm()">注册</a>
			<div class="center mt15 f12">
				注册视为已经阅读并同意<a href="agreement.html">《服务协议》</a>
			</div>
		</div>
	</div>
</body>

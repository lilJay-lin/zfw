...
function submitForm() {
	...
	$.ajax({
		type: "POST",
		async: true,
		url: "${ctx}/user/xzl/json/add",
		data: {grossFloorArea:grossFloorArea,region:region,type:type,decorationStatus:decorationStatus,propertyFee:propertyFee,rental:rental,totalPrice:totalPrice,rentOrSale:rentOrSale,phoneNum:phoneNum,name:name,address:address,introduction:introduction,preImageUrl:preImageUrl,imgUrls:imgUrls},
		dataType: "json",

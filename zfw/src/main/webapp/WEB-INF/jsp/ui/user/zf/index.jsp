...
<body>
	<div class="main">
		...
		<div class="pc-content-list whitebg">
			<a class="pc-content-item" href="${ctx }/user/zf/add">
				<div class="bor">
					<span class="flol icon zf"></span> <span class="flol">发布租房</span>
				</div>
			</a>
		</div>
		<c:choose>
...
var curp = 1;
	...
	function load(){
		...
		draginner.html("正在加载...");
		var url = "${ctx}/user/zf/json/{targetPage}-{pageSize}/search";
			...
			success: function(json){
				if(json.success){
					for(var i=0;i<json.results.length;i++){
						...
						var str = '<li><a id="{id}" href="${ctx}/user/zf/{id}/manage"> <div class="img"> <img src="{preImageUrl}"> </div> <div class="txt"> <p class="x-intro"> <h2>{name}</h2> <span class="new">{outOfDate}</span> </p> <p>{numMsgStr}</p> <div class="stag"> <span class="t1">{residenceCommunityName} </div> </div> </a></li>';
						var numMsgStr = "";

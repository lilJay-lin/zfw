...
function submitForm() {
	...
	$.ajax({
		...
		data: {residenceCommunityName:xqName,residenceCommunityId:xqId,roomNum:roomNum,hallNum:hallNum,toiletNum:toiletNum,insideArea:insideArea,grossFloorArea:grossFloorArea,forward:forward,decorationStatus:decorationStatus,leaseWay:leaseWay,facilityBed:facilityBed,facilityBroadband:facilityBroadband,facilityTv:facilityTv,facilityWasher:facilityWasher,facilityRefrigerator:facilityRefrigerator,facilityAirConditioner:facilityAirConditioner,facilityHeating:facilityHeating,facilityHeater:facilityHeater,curFloor:curFloor,totalFloor:totalFloor,rental:rental,phoneNum:phoneNum,name:name,address:address,introduction:introduction,preImageUrl:preImageUrl,imgUrls:imgUrls},
		dataType: "json",

...
<body>
	<div class="main">
		...
		<div class="pc-content-list whitebg">
			<a class="pc-content-item" href="${ctx }/user/cfck/add">
				<div class="bor">
					<span class="flol icon sp"></span> <span class="flol">发布厂房仓库</span>
				</div>
			</a>
		</div>
		<c:choose>
...
var curp = 1;
	...
	function load(){
		...
		draginner.html("正在加载...");
		var url = "${ctx}/user/cfck/json/{targetPage}-{pageSize}/search";
			...
			success: function(json){
				if(json.success){
					for(var i=0;i<json.results.length;i++){
						...
						var str = '<li><a id="{id}" href="${ctx}/user/cfck/{id}/manage"> <div class="img"> <img src="{preImageUrl}"> </div> <div class="txt"> <p class="x-intro"> <h2>{name}</h2> <span class="new">{outOfDate}</span> </p> <p>{grossFloorArea}</p> <div class="stag"> <span class="t1">{address} </div> </div> </a></li>';

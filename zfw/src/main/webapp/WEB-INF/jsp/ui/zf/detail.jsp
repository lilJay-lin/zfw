...
<html>
<head>
<c:set var="headKeywords" value="${zf.tags}"/>
<c:set var="headTitle" value="${zf.name}"/>
	...
	<div class="main">
		...
		<section class=" pd10 f14 mt10 bdt bdb lh105">
			<div class="detailMsg">
				...
				<p>
					建筑面积：<span class="f999">约${zf.grossFloorArea}㎡</span>
				</p>
				<p>
					套内面积：<span class="f999">约${zf.insideArea}㎡</span>
				</p>
				<p>

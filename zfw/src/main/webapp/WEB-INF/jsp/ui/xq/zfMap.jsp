...
<html>
<head>
<c:set var="headKeywords" value="租房地图"/>
<c:set var="headTitle" value="租房地图"/>
...
<body>
	...
	<input type="hidden" id="defaultLon" value="${rc.longitude}">
	<input type="hidden" id="defaultLat" value="${rc.latitude}">
</body>
...
<script>
	...
	function reSearch(){
		...
		var url = "${ctx}/xq/zf/json/{region}-{rental}-{roomNum}-{grossFloorArea}-{bound}/search";
    ...
    ComplexCustomOverlay.prototype.initialize = function(map){
      ...
      div.addEventListener("touchend",function(){
    	  if(!moved && targetId){
    		  top.location='${ctx}/xq/'+targetId+'/detail';
    	  }
      });
...
//     	  this._div.style.border = "0px none";
	...
	function bindSearchData(url){
		...
		var rental = queryingConditions["rental"];
